...
class WSHandler
{
     ...
     */
    public function __construct(\CharlotteDunois\Yasmin\WebSocket\WSManager $wsmanager)
    {
     ...
     * @return void
     */
    public function handle(\CharlotteDunois\Yasmin\WebSocket\WSConnection $ws, $message)
    {
