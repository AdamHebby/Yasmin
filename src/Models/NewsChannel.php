...
/**
 * Represents a guild's news channel.
 *
 * @property string                                               $id                     The ID of the channel.
 * @property string                                               $name                   The channel name.
 * @property \CharlotteDunois\Yasmin\Models\Guild                 $guild                  The guild this news channel belongs to.
 ...
 */
class NewsChannel extends ClientBase implements \CharlotteDunois\Yasmin\Interfaces\NewsChannelInterface
{
    use \CharlotteDunois\Yasmin\Traits\GuildChannelTrait;

    /**
     * The guild this news channel belongs to.
     *
     ...
     * @internal
     */
    public function __construct(\CharlotteDunois\Yasmin\Client $client, \CharlotteDunois\Yasmin\Models\Guild $guild, array $channel)
    {
    ...
    /**
     * Returns all channels which are childrens of this news.
     *
