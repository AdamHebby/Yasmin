...
class URLHelpers
{
     ...
     * @internal
     */
    public static function setLoop(\React\EventLoop\LoopInterface $loop)
    {
        static::$loop = $loop;
     ...
     */
    public static function setHTTPClient(\Clue\React\Buzz\Browser $client)
    {
        if (static::$http !== null) {
     ...
     */
    public static function makeRequest(\Psr\Http\Message\RequestInterface $request, ?array $requestOptions = null)
    {
     ...
     */
    public static function applyRequestOptions(\Psr\Http\Message\RequestInterface $request, array $requestOptions)
    {
