...
class Channel
{
    ...
    public function createMessage(string $channelid, array $options, array $files = array())
    {
    ...
    public function getMessageReactions(string $channelid, string $messageid, string $emoji, array $querystring = array())
    {
    ...
    public function createChannelInvite(string $channelid, array $options = array())
    {
