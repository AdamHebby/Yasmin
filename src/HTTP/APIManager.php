...
class APIManager
{
     ...
     * @return \React\Promise\ExtendedPromiseInterface
     */
    public function add(\CharlotteDunois\Yasmin\HTTP\APIRequest $apirequest)
    {
...
*/
     ...
     * @return string
     */
    public function getRatelimitEndpoint(\CharlotteDunois\Yasmin\HTTP\APIRequest $request)
    {
     ...
     * @throws \Throwable
     */
    public function extractRatelimit(\Psr\Http\Message\ResponseInterface $response)
    {
     ...
     * @throws \Throwable
     */
    public function handleRatelimit(\Psr\Http\Message\ResponseInterface $response, ?\CharlotteDunois\Yasmin\Interfaces\RatelimitBucketInterface $ratelimit = null, bool $isReactionEndpoint = false)
    {
